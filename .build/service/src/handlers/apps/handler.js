...
/***/ "./src/handlers/apps/appErrors.ts":
/*!****************************************!*\
  !*** ./src/handlers/apps/appErrors.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var ErrorTypesEnum_1 = __webpack_require__(/*! @/types/ErrorTypesEnum */ "./src/types/ErrorTypesEnum.ts");
var error_1 = __webpack_require__(/*! @/lib/error */ "./lib/error.ts");
var buildAppNotFoundError = function (id) { return error_1.error.build({
    message: "App com id ".concat(id, " n\u00E3o encontrado!"),
    statusCode: 412,
    type: ErrorTypesEnum_1.ErrorTypesEnum.APP_NOT_FOUND
}); };
var appErrors = {
    buildAppNotFoundError: buildAppNotFoundError
};
...
/***/ "./src/handlers/apps/appService.ts":
/*!*****************************************!*\
  !*** ./src/handlers/apps/appService.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var error_1 = __webpack_require__(/*! @/lib/error */ "./lib/error.ts");
var appModel_1 = __webpack_require__(/*! @/models/appModel */ "./src/models/appModel.ts");
var logService_1 = __webpack_require__(/*! ../log/logService */ "./src/handlers/log/logService.ts");
var appErrors_1 = __webpack_require__(/*! ./appErrors */ "./src/handlers/apps/appErrors.ts");
var create = function (data, user) { return __awaiter(void 0, void 0, void 0, function () {
    var app;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, appModel_1.App.create(data)];
            case 1:
                app = _a.sent();
                return [4 /*yield*/, logService_1.logService.create({
                        user: user._id,
                        event: 'Criar app',
                        detail: "App com id ".concat(app._id, " criado com sucesso!")
                    })];
            case 2:
                _a.sent();
                return [2 /*return*/, app];
...
var findById = function (appId, user) { return __awaiter(void 0, void 0, void 0, function () {
    var app;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, appModel_1.App.findById(appId)];
            case 1:
                app = _a.sent();
                if (!app) {
                    throw appErrors_1.appErrors.buildAppNotFoundError(appId);
                }
                return [4 /*yield*/, logService_1.logService.create({
                        user: user._id,
                        event: 'Obter app',
                        detail: "App obtido com o id ".concat(appId)
                    })];
            case 2:
                _a.sent();
                return [2 /*return*/, app];
...
var update = function (_a, user) { return __awaiter(void 0, void 0, void 0, function () {
    var updatedApp;
    var _id = _a._id, body = __rest(_a, ["_id"]);
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!_id) {
                    throw error_1.error.buildSchemaValidationError({
                        message: 'ID do app não foi informado!'
                    });
                }
                delete body.totalRating;
                return [4 /*yield*/, appModel_1.App.findByIdAndUpdate(_id, body, { new: true })];
            case 1:
                updatedApp = _b.sent();
                if (!updatedApp) {
                    throw appErrors_1.appErrors.buildAppNotFoundError(_id);
                }
                return [4 /*yield*/, logService_1.logService.create({
                        user: user._id,
                        event: 'Alterar app',
                        detail: "App com id ".concat(_id, " alterado com sucesso!")
                    })];
            case 2:
                _b.sent();
...
var list = function (_a, user) {
    var search = _a.search, _b = _a.page, page = _b === void 0 ? 1 : _b, _c = _a.perPage, perPage = _c === void 0 ? 50 : _c;
    return __awaiter(void 0, void 0, void 0, function () {
        var maxPages, skip, filter, apps, totalSize;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    maxPages = Math.min(+perPage, 50);
                    skip = (+page - 1) * +perPage;
                    filter = {
                        name: new RegExp(search, 'i')
                    };
                    return [4 /*yield*/, appModel_1.App.find(filter)
                            .skip(skip)
                            .limit(maxPages)];
                case 1:
                    apps = _d.sent();
                    return [4 /*yield*/, appModel_1.App.countDocuments(filter)];
                case 2:
                    totalSize = _d.sent();
                    return [4 /*yield*/, logService_1.logService.create({
                            user: user._id,
                ...
                case 3:
                    _d.sent();
                    return [2 /*return*/, { apps: apps, totalSize: totalSize }];
            }
        });
    });
};
var remove = function (appId, user) { return __awaiter(void 0, void 0, void 0, function () {
    var app, removedApp;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, appModel_1.App.findById(appId)];
            case 1:
                ...
                return [4 /*yield*/, appModel_1.App.findByIdAndRemove(appId)];
            case 2:
                removedApp = _a.sent();
                return [4 /*yield*/, logService_1.logService.create({
                        user: user._id,
                        event: 'Remover app',
                        detail: "O app com id ".concat(appId, " foi removido com sucesso!")
                    })];
            case 3:
                _a.sent();
                return [2 /*return*/, removedApp];
        }
    });
}); };
var appService = {
...
/***/ "./src/handlers/apps/createApp.ts":
/*!****************************************!*\
  !*** ./src/handlers/apps/createApp.ts ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var appService_1 = __webpack_require__(/*! ./appService */ "./src/handlers/apps/appService.ts");
var createApp = function (_a) {
    var body = _a.body, user = _a.user;
    return __awaiter(void 0, void 0, void 0, function () {
        var app;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, appService_1.appService.create(body, user)];
                case 1:
                    app = _b.sent();
                    return [2 /*return*/, { app: app }];
            }
        });
    });
};
...
/***/ "./src/handlers/apps/deleteApp.ts":
/*!****************************************!*\
  !*** ./src/handlers/apps/deleteApp.ts ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    appId = params.appId;
                    return [4 /*yield*/, appService_1.appService.remove(appId, user)];
                case 1:
                    app = _b.sent();
                    return [2 /*return*/, { app: app }];
            }
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    appId = params.appId;
                    return [4 /*yield*/, appService_1.appService.findById(appId, user)];
                case 1:
                    app = _b.sent();
                    return [2 /*return*/, { app: app }];
            }
...
var appService_1 = __webpack_require__(/*! ./appService */ "./src/handlers/apps/appService.ts");
var listApps = function (_a) {
    var user = _a.user, query = _a.query;
    return __awaiter(void 0, void 0, void 0, function () {
        var search, page, perPage, apps;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    search = query.search, page = query.page, perPage = query.perPage;
                    return [4 /*yield*/, appService_1.appService.list({ search: search, page: page, perPage: perPage }, user)];
                case 1:
                    apps = _b.sent();
...
/***/ "./src/handlers/apps/updateApp.ts":
/*!****************************************!*\
  !*** ./src/handlers/apps/updateApp.ts ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var appService_1 = __webpack_require__(/*! ./appService */ "./src/handlers/apps/appService.ts");
var updateApp = function (_a) {
    var body = _a.body, user = _a.user;
    return __awaiter(void 0, void 0, void 0, function () {
        var app;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, appService_1.appService.update(body, user)];
                case 1:
                    app = _b.sent();
                    return [2 /*return*/, { app: app }];
            }
...
var ErrorTypesEnum_1 = __webpack_require__(/*! @/types/ErrorTypesEnum */ "./src/types/ErrorTypesEnum.ts");
var error_1 = __webpack_require__(/*! @/lib/error */ "./lib/error.ts");
var buildLogNotFoundError = function (id) { return error_1.error.build({
    message: "Log com id ".concat(id, " n\u00E3o encontrado!"),
    statusCode: 412,
    type: ErrorTypesEnum_1.ErrorTypesEnum.LOG_NOT_FOUND
}); };
var logErrors = {
    buildLogNotFoundError: buildLogNotFoundError
};
...
/***/ "./src/handlers/log/logService.ts":
/*!****************************************!*\
  !*** ./src/handlers/log/logService.ts ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var logModel_1 = __webpack_require__(/*! @/models/logModel */ "./src/models/logModel.ts");
var logErrors_1 = __webpack_require__(/*! ./logErrors */ "./src/handlers/log/logErrors.ts");
var create = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var logDb;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, logModel_1.Log.create(data)];
            case 1:
                logDb = _a.sent();
                try {
                    return [2 /*return*/, logDb];
                }
                catch (err) {
                    return [2 /*return*/, {}];
                }
...
var add = function (user, event, detail) { return __awaiter(void 0, void 0, void 0, function () {
    var log;
    return __generator(this, function (_a) {
        log = {
            user: user,
        ...
        return [2 /*return*/, create(log)];
    });
}); };
var findById = function (logId) { return __awaiter(void 0, void 0, void 0, function () {
    var log;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, logModel_1.Log.findById(logId)];
            case 1:
                log = _a.sent();
                if (!log) {
                    throw logErrors_1.logErrors.buildLogNotFoundError(logId);
                }
                return [2 /*return*/, log];
        }
    });
...
var list = function (_a) {
    var _b = _a.search, search = _b === void 0 ? '' : _b, _c = _a.page, page = _c === void 0 ? 1 : _c, _d = _a.perPage, perPage = _d === void 0 ? 50 : _d;
    return __awaiter(void 0, void 0, void 0, function () {
        var maxPages, skip, filter, totalSize, logs;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, logModel_1.Log.countDocuments(filter)];
                case 1:
                    totalSize = _e.sent();
                    return [4 /*yield*/, logModel_1.Log.find(filter)
                            .skip(skip)
                            .limit(maxPages)];
                case 2:
                    logs = _e.sent();
                    return [2 /*return*/, { logs: logs, totalSize: totalSize }];
            }
        });
    });
};
...
var AppTypesEnum_1 = __webpack_require__(/*! @/types/AppTypesEnum */ "./src/types/AppTypesEnum.ts");
...
var AppSchema = new mongoose_1.Schema({
    ...
    status: {
        type: String,
        enum: AppTypesEnum_1.AppStatusEnum,
        default: AppTypesEnum_1.AppStatusEnum.DRAFT
    }
}, {
    timestamps: true,
    toJSON: {
...
(0, mongooseErrorValidator_1.mongooseErrorValidator)(AppSchema);
var App = mongoose_1.models.apps || (0, mongoose_1.model)(TableEnum_1.CollectionsEnum.Apps, AppSchema, TableEnum_1.CollectionsEnum.Apps);
exports.App = App;
...
var TableEnum_1 = __webpack_require__(/*! @/types/TableEnum */ "./src/types/TableEnum.ts");
var mongoose_1 = __webpack_require__(/*! mongoose */ "mongoose");
var userModel_1 = __webpack_require__(/*! ./userModel */ "./src/models/userModel.ts");
var mongooseErrorValidator_1 = __webpack_require__(/*! @/lib/mongooseErrorValidator */ "./lib/mongooseErrorValidator.ts");
var LogSchema = new mongoose_1.Schema({
    user: {
        type: mongoose_1.Schema.Types.ObjectId,
        ref: userModel_1.User.collection.collectionName,
        required: [true, 'user'],
        index: true
    },
    event: {
...
(0, mongooseErrorValidator_1.mongooseErrorValidator)(LogSchema);
var Log = mongoose_1.models.logs || (0, mongoose_1.model)(TableEnum_1.CollectionsEnum.Logs, LogSchema, TableEnum_1.CollectionsEnum.Logs);
exports.Log = Log;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AppStatusEnum = exports.AppCategoryEnum = void 0;
var AppStatusEnum;
(function (AppStatusEnum) {
    AppStatusEnum["PRODUCTION"] = "PRODUCTION";
    AppStatusEnum["DRAFT"] = "DRAFT";
    AppStatusEnum["TESTING"] = "TESTING";
    AppStatusEnum["REVIEW"] = "REVIEW";
    AppStatusEnum["REJECTED"] = "REJECTED";
    AppStatusEnum["PREVIOUS"] = "PREVIOUS";
})(AppStatusEnum || (AppStatusEnum = {}));
exports.AppStatusEnum = AppStatusEnum;
var AppCategoryEnum;
(function (AppCategoryEnum) {
    AppCategoryEnum["APPS_TO_SMARTWATCH"] = "APPS_TO_SMARTWATCH";
    AppCategoryEnum["ART_AND_DESIGN"] = "ART_AND_DESIGN";
    AppCategoryEnum["BEAUTY"] = "BEAUTY";
    AppCategoryEnum["LIBRARIES_AND_DEMOS"] = "LIBRARIES_AND_DEMOS";
    AppCategoryEnum["HOUSES_AND_DECORATION"] = "HOUSES_AND_DECORATION";
    AppCategoryEnum["WEATHER"] = "WEATHER";
    AppCategoryEnum["EAT_AND_DRINK"] = "EAT_AND_DRINK";
    AppCategoryEnum["SHOPPING"] = "SHOPPING";
    AppCategoryEnum["COMMUNICATION"] = "COMMUNICATION";
    AppCategoryEnum["PHOTOGRAPHY"] = "PHOTOGRAPHY";
    AppCategoryEnum["HUMOR"] = "HUMOR";
    AppCategoryEnum["BOOKS_AND_REFERENCE"] = "BOOKS_AND_REFERENCE";
    AppCategoryEnum["MAPS_AND_NAVIGATION"] = "MAPS_AND_NAVIGATION";
    AppCategoryEnum["MEDICINE"] = "MEDICINE";
    AppCategoryEnum["WATCH_FACES"] = "WATCH_FACES";
    AppCategoryEnum["MUSIC_AND_AUDIO"] = "MUSIC_AND_AUDIO";
    AppCategoryEnum["NEWS_AND_MAGAZINES"] = "NEWS_AND_MAGAZINES";
    AppCategoryEnum["CUSTOMIZATION"] = "CUSTOMIZATION";
})(AppCategoryEnum || (AppCategoryEnum = {}));
exports.AppCategoryEnum = AppCategoryEnum;
...
var createApp_1 = __webpack_require__(/*! ./createApp */ "./src/handlers/apps/createApp.ts");
var deleteApp_1 = __webpack_require__(/*! ./deleteApp */ "./src/handlers/apps/deleteApp.ts");
var getApp_1 = __webpack_require__(/*! ./getApp */ "./src/handlers/apps/getApp.ts");
var listApps_1 = __webpack_require__(/*! ./listApps */ "./src/handlers/apps/listApps.ts");
var updateApp_1 = __webpack_require__(/*! ./updateApp */ "./src/handlers/apps/updateApp.ts");
var router = (0, router_1.buildRouter)();
router.post('/apps', auth_1.auth.verifyLogged(createApp_1.createApp));
router.get('/apps/{appId}', auth_1.auth.verifyLogged(getApp_1.getApp));
router.put('/apps', auth_1.auth.verifyLogged(updateApp_1.updateApp));
router.get('/apps', auth_1.auth.verifyLogged(listApps_1.listApps));
router.delete('/apps/{appId}', auth_1.auth.verifyLogged(deleteApp_1.removeApp));
