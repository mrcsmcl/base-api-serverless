...
var userService_1 = __webpack_require__(/*! ./userService */ "./src/handlers/user/userService.ts");
var create = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, userService_1.userService.create(body)];
                case 1:
                    response = _b.sent();
                    return [2 /*return*/, response];
            }
...
var create_1 = __webpack_require__(/*! ./create */ "./src/handlers/user/create.ts");
var router = (0, router_1.buildRouter)();
router.post('/users', create_1.create);
