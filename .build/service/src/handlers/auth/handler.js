...
/***/ "./src/handlers/auth/authErrors.ts":
/*!*****************************************!*\
  !*** ./src/handlers/auth/authErrors.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var ErrorTypesEnum_1 = __webpack_require__(/*! @/types/ErrorTypesEnum */ "./src/types/ErrorTypesEnum.ts");
var error_1 = __webpack_require__(/*! @/lib/error */ "./lib/error.ts");
var loginError = function () { return error_1.error.build({
    type: ErrorTypesEnum_1.ErrorTypesEnum.INVALID_PASSWORD_OR_EMAIL,
    statusCode: 401,
...
/***/ "./src/handlers/auth/authService.ts":
/*!******************************************!*\
  !*** ./src/handlers/auth/authService.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var authErrors_1 = __webpack_require__(/*! ./authErrors */ "./src/handlers/auth/authErrors.ts");
...
var createToken = function (userId) { return jwt_1.jwt.create({
    user_id: userId
}); };
var authenticateUser = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    var token, userToAuth;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                token = createToken(userId);
                return [4 /*yield*/, userModel_1.User.findById(userId).select('-password')];
            case 1:
                userToAuth = (_a = (_b.sent())) === null || _a === void 0 ? void 0 : _a.toObject({ virtuals: true });
                return [2 /*return*/, {
                        user: userToAuth,
                        token: token
                    }];
...
var auth = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var passHash, userToAuth, _b, user, token;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    passHash = hash_1.hash.encode(password);
                ...
                case 1:
                    userToAuth = _c.sent();
                    if (!userToAuth) {
                        throw authErrors_1.authErrors.loginError();
                    }
                    return [4 /*yield*/, authenticateUser(userToAuth._id)];
                case 2:
                    _b = _c.sent(), user = _b.user, token = _b.token;
                    return [4 /*yield*/, logService_1.logService.create({
                            user: userToAuth._id,
                            event: 'User realizou login',
                            detail: "Usu\u00E1rio com id ".concat(userToAuth._id, " realizou login")
                        })];
                case 3:
                    _c.sent();
                    return [2 /*return*/, {
...
var authService_1 = __webpack_require__(/*! @/handlers/auth/authService */ "./src/handlers/auth/authService.ts");
var authUser = function (_a) {
    var body = _a.body;
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, user, token;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, authService_1.authService.auth(body)];
                case 1:
                    _b = _c.sent(), user = _b.user, token = _b.token;
                    return [2 /*return*/, {
                            user: user,
...
var authUser_1 = __webpack_require__(/*! ./authUser */ "./src/handlers/auth/authUser.ts");
var router = (0, router_1.buildRouter)();
router.post('/auth', authUser_1.authUser);
